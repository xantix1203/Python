...
class Player:
        ...
        while launched:
            for event in pg.event.get():
                if event.type == pg.MOUSEMOTION:  # affichage bateau temporaire
                    x_grid0, y_grid0 = self.event_mousemotion(event, window, opponent, all_boats, x_grid0, y_grid0)
    ...
    def event_mousemotion(self, event, window, opponent, all_boats, x_grid0, y_grid0):
